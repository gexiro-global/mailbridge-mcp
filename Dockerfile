...
COPY scripts/provision-container-secrets.mjs ./scripts/provision-container-secrets.mjs
COPY src ./src
RUN npm run build \
...
COPY --from=build --chown=10001:10001 /app/scripts/provision-container-secrets.mjs ./scripts/provision-container-secrets.mjs
